...
namespace WS_Integrador_GP_BSALE.Utils
{
    public class DocumentType3
    {
        ...
        public string messageBodyFormat { get; set; }
    ...
    public class Client3
    {
        ...
        public PaymentType3 payment_type { get; set; }
        [JsonProperty("sale_condition", NullValueHandling = NullValueHandling.Ignore)]
        public SaleCondition3 sale_condition { get; set; }
    }

    public class PaymentType3
    {
        [JsonProperty("href", NullValueHandling = NullValueHandling.Ignore)]
        public string href { get; set; }
        [JsonProperty("id", NullValueHandling = NullValueHandling.Ignore)]
    ...
    public class Sellers3
    {
        [JsonProperty("href", NullValueHandling = NullValueHandling.Ignore)]
        public string href { get; set; }
    }

    public class PedidoBSale
    {
        [JsonProperty("href", NullValueHandling = NullValueHandling.Ignore)]
        public string href { get; set; }
        [JsonProperty("id", NullValueHandling = NullValueHandling.Ignore)]
